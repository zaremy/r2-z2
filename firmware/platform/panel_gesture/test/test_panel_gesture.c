...
static void test_a_hold_fires_once_at_the_bound_not_before(void)
{
    panel_hold_t h = {0};
    bool fire;
...
static void test_lifting_early_cancels(void)
{
    panel_hold_t h = {0};
    bool fire;
...
static void test_a_drag_cancels_and_cannot_restart(void)
{
    panel_hold_t h = {0};
    bool fire;
    panel_hold_step(&h, true, true, false, 0, 0, &fire);
...
static void test_outside_the_target_never_fires(void)
{
    panel_hold_t h = {0};
    bool fire, any = false;
...
static void test_the_next_press_rearms(void)
{
    panel_hold_t h = {0};
    bool fire;
    panel_hold_step(&h, true, true, false, 0, 0, &fire);
...
static void test_a_hold_across_the_clock_wrap(void)
{
    panel_hold_t h = {0};
    bool fire;
...
int main(void)
{
    ...
    test_a_hold_fires_once_at_the_bound_not_before();
    test_lifting_early_cancels();
    test_a_drag_cancels_and_cannot_restart();
